...
switch ($method) {
    ...
    case 'POST':
        ...
        echo json_encode(['message' => 'register added successfully']);
        break;
    case 'PUT':
        ...
        $stmt = $pdo->prepare('UPDATE register SET password=?, firstname=?, lastname=?, org=? WHERE id=?');
        $stmt->execute([$password, $firstname, $lastname, $org, $id]);

        echo json_encode(['message' => 'register updated successfully']);
        break;
    case 'DELETE':
        ...
        echo json_encode(['message' => 'register deleted successfully']);
        break;
}
